...
This creates the directory `dist` which contains "wheels", which are the binary distribution format for Python packages. These wheels will have file names such as `vehicle_lang-0.20.0-cp311-cp311-macosx_13_0_arm64`:
...
#   versions      \
#                  vvvvvvvvvvv
vehicle_lang-0.20.0-cp311-cp311-macosx_13_0_arm64
#                              ^^^^^^^^^^^^^^^^^
#   Supported                /
...
9. **On a macOS machine with an M1/M2 chipset**
   ...
   ```
   vehicle_lang-0.20.0-cp310-cp310-macosx_13_0_arm64.whl
   vehicle_lang-0.20.0-cp37-cp37m-macosx_13_0_arm64.whl
   vehicle_lang-0.20.0-cp39-cp39-macosx_13_0_arm64.whl
   vehicle_lang-0.20.0-cp311-cp311-macosx_13_0_arm64.whl
   vehicle_lang-0.20.0-cp38-cp38-macosx_13_0_arm64.whl
   ```
   ...
   **Warning**: The following is a destructive action! Published versions cannot be changed!
   ...
   <https://github.com/vehicle-lang/vehicle/releases/tag/v0.20.0>
